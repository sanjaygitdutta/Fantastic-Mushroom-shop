...
export default function PriceHistoryChart({ query, prices }: PriceHistoryChartProps) { // refresh
  ...
  return (
    <div className="mt-8">
      ...
      <button
        ...
        className="w-full flex items-center justify-between bg-linear-to-r from-forest-800 to-forest-700 hover:from-forest-700 hover:to-forest-600 text-white rounded-2xl px-6 py-4 transition-all group"
      >
