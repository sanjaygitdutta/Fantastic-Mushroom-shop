...
export default function RecipePage() {
  ...
  const displayIngredients = (lang !== 'en' && tRecipe.ingredients && tRecipe.ingredients.length > 0)
    ? tRecipe.ingredients.map((i) => `${i.amount} ${i.item}`)
    : recipe.ingredients;
  const displaySteps = (lang !== 'en' && tRecipe.instructions && tRecipe.instructions.length > 0)
