        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="prose prose-lg prose-forest max-w-none bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-forest-100 mb-12">
            ...
            <div className="mt-12 bg-linear-to-br from-forest-900 to-forest-800 rounded-2xl p-8 text-center text-white">
              ...
              <p className="text-forest-200 mb-6">{t(isSG ? 'blog_compare_desc_sg' : 'blog_compare_desc', { defaultValue: isSG ? 'Instantly compare live prices across FairPrice, RedMart, and Cold Storage before you buy.' : 'Instantly compare live prices across Blinkit, Zepto, and Swiggy Instamart before you buy.' })}</p>
