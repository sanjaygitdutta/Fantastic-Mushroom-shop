                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <a href={getAffiliateUrl(platform.id, platform.searchUrl(selectedRecipe.ingredients[0].query))} target="_blank" rel="noopener noreferrer"
                              onClick={handleAffiliateClick}
                              className="flex items-center gap-1 text-xs border border-gray-200 rounded-xl px-3 py-2 text-gray-500 hover:text-forest-700 hover:border-forest-300 transition-colors"
                            >
