    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden pt-20">
        ...
        <motion.div style={{ opacity: opacityText, y: useTransform(scrollY, [0, 400], [0, 100]) }} className="max-w-5xl mx-auto text-center z-10">
          ...
          >
            Search any food item and instantly see prices across all major delivery platforms.
            Buy where it's cheapest — no more overpaying.
          </motion.p>
          ...
          >
            <span className="text-forest-400 text-sm self-center">Comparing on:</span>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            >
              How Fantastic Food Works
            </motion.h2>
            <p className="section-subtitle mx-auto text-center">
              Three steps to finding the best price on anything edible
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
          <Link to="/basket" className="group relative bg-white border border-forest-200 hover:border-moss-500 rounded-3xl p-8 overflow-hidden transition-all hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-black font-display text-forest-900 mb-2">Smart Basket Calculator</h3>
              <p className="text-forest-600 mb-6 max-w-sm">Add multiple groceries and instantly find which platform is cheapest for your entire list.</p>
          ...
          <Link to="/meal-calculator" className="group relative bg-white border border-forest-200 hover:border-amber-500 rounded-3xl p-8 overflow-hidden transition-all hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="relative z-10">
              <span className="text-4xl mb-4 block">🍳</span>
              <h3 className="text-2xl font-black font-display text-forest-900 mb-2">Meal Cost Calculator</h3>
              <p className="text-forest-600 mb-6 max-w-sm">Pick a recipe and find out exactly how much cooking it at home costs across all platforms.</p>
              <span className="inline-flex items-center gap-2 text-amber-600 font-bold group-hover:gap-3 transition-all">
                Calculate meal cost <ArrowRight className="w-4 h-4" />
              </span>
            </div>
          </Link>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
            <div>
              ...
              <p className="text-forest-600 text-sm mt-1">Most compared food items today</p>
            </div>
      ...
      <section className="py-16 px-4 bg-forest-900 text-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-black font-display mb-3 text-white">Why Fantastic Food?</h2>
            <p className="text-forest-300">More savings, less effort</p>
          </div>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 text-white">
            ...
            <p className="text-earth-300 text-lg mb-7 max-w-md">
              Can't find mushrooms cheaper anywhere? Order our premium, farm-fresh mushrooms directly — no middlemen, best quality.
            </p>
