...
const RecipeDetails = () => {
    ...
    if (!recipe) {
        return <div className="min-h-screen pt-24 text-center">Recipe not found</div>;
    }
            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="mb-10">
                    ...
                    <div className="flex flex-wrap gap-6 text-gray-700 border-y border-gray-100 py-6">
                        <div className="flex items-center">
                            ...
                            <span className="font-semibold mr-1">Prep:</span> {recipe.prepTime}
                        </div>
                        <div className="flex items-center">
                            <ChefHat className="w-5 h-5 mr-2 text-forest-500" />
                            <span className="font-semibold mr-1">Cook:</span> {recipe.cookTime}
                        </div>
                        <div className="flex items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <h3 className="text-2xl font-bold text-forest-900 mb-6">Instructions</h3>
