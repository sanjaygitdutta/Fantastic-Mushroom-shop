...
const CITIES: Record<string, CityData> = {
  ...
  navi_mumbai: { name: 'Navi Mumbai', slug: 'navi-mumbai', state: 'Maharashtra', emoji: '🌆', pincode: '400701', platforms: ['Blinkit', 'Zepto', 'Swiggy Instamart', 'BigBasket', 'Amazon Fresh', 'JioMart'], trending: ['Fish', 'Rice', 'Milk', 'Eggs', 'Tomato', 'Onion', 'Paneer', 'Bread'], description: 'Navi Mumbai grocery price comparison — compare all 6 apps for the best daily grocery deals in New Mumbai.' },
};
