...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    ...
    alternates: {
      canonical: lang === 'en' ? 'https://www.fantasticfood.in/seasonal' : `https://www.fantasticfood.in/${lang}/seasonal`,
      languages: {
        'en': 'https://www.fantasticfood.in/seasonal',
        ...
        'zh-CN': 'https://www.fantasticfood.in/zh-CN/seasonal',
        'ms': 'https://www.fantasticfood.in/ms/seasonal',
        'x-default': 'https://www.fantasticfood.in/seasonal',
      },
    },
  };
}
