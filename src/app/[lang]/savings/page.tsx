...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    ...
    alternates: {
      canonical: lang === 'en' ? 'https://www.fantasticfood.in/savings' : `https://www.fantasticfood.in/${lang}/savings`,
      languages: {
        'en': 'https://www.fantasticfood.in/savings',
        ...
        'zh-CN': 'https://www.fantasticfood.in/zh-CN/savings',
        'ms': 'https://www.fantasticfood.in/ms/savings',
        'x-default': 'https://www.fantasticfood.in/savings',
      },
    },
  };
}
