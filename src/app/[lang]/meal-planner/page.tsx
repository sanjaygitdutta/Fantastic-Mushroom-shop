...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    ...
    alternates: {
      canonical: lang === 'en' ? 'https://www.fantasticfood.in/meal-planner' : `https://www.fantasticfood.in/${lang}/meal-planner`,
      languages: {
        'en': 'https://www.fantasticfood.in/meal-planner',
        ...
        'zh-CN': 'https://www.fantasticfood.in/zh-CN/meal-planner',
        'ms': 'https://www.fantasticfood.in/ms/meal-planner',
        'x-default': 'https://www.fantasticfood.in/meal-planner',
      },
    },
  };
}
